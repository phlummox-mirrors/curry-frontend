...
test12 = ('a', 2 :: Int) > ('a', 1)
test13 = ('a', 1 :: Int) < ('a', 2)
test14 = ('a', 1 :: Int, 2 :: Int) < ('a', 1, 3)
test15 = ('a', 1 :: Int, 2 :: Int) < ('b', 1, 2)
test16 = ('a', 1 :: Int, 2 :: Int) <= ('a', 1, 2)
test17 = S1 True True () <= S1 True True ()
test18 = S1 True True () < S2
test19 = S2 > S1 True True ()
test20 = S1 (1 :: Int) (1 :: Int) (1 :: Int) <= S1 1 1 1
test21 = S1 (1 :: Int) (1 :: Int) (1 :: Int) <  S1 2 1 1
test22 = S1 (1 :: Int) (1 :: Int) (1 :: Int) <  S1 1 2 1
test23 = S1 (1 :: Int) (1 :: Int) (1 :: Int) <  S1 1 1 2
test24 = compare (S1 (1 :: Int) (1 :: Int) (1 :: Int)) S2 == LT
test25 = compare S2 (S1 (1 :: Int) (1 :: Int) (1 :: Int)) == GT
...
test32 = U False (0 :: Int) < U True 0
test33 = U False (0 :: Int) < U False 1

test34 = C0 <= C0
test35 = not (C0 < C0)
test36 = not (C0 > C0)

test37 = C4 (1 :: Int) (1 :: Int) (1 :: Int) (1 :: Int) <= C4 1 1 1 1
test38 = C4 (1 :: Int) (1 :: Int) (1 :: Int) (1 :: Int) < C4 2 1 1 1
test39 = C4 (1 :: Int) (1 :: Int) (1 :: Int) (1 :: Int) < C4 1 2 1 1
test40 = C4 (1 :: Int) (1 :: Int) (1 :: Int) (1 :: Int) < C4 1 1 2 1
test41 = C4 (1 :: Int) (1 :: Int) (1 :: Int) (1 :: Int) < C4 1 1 1 2
...
test48 = not (([] :: [()]) > [])
test49 = [1 :: Int, 2] <= [1, 2]
test50 = not ([1 :: Int, 2] < [1, 2])
test51 = not ([1 :: Int, 2] > [1, 2])
test52 = [1 :: Int, 2] < [1, 3]
test53 = [1 :: Int, 2] < [2, 0]
test54 = [1 :: Int, 2, 3] < [1, 2, 4]
test55 = [1 :: Int, 2, 3] < [1, 3, 0]
test56 = [1 :: Int, 2, 3] < [4, 2, 3]
