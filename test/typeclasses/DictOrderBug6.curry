...
instance (Eq b, Eq a) => Eq (a, b) where
...
instance (Eq c, Eq b, Eq a) => Eq (a, b, c) where
...
instance (Eq d, Eq c, Eq b, Eq a) => Eq (a, b, c, d) where
...
instance (Eq e, Eq d, Eq c, Eq b, Eq a) => Eq (a, b, c, d, e) where
