...
data CTypeDecl = CType    QName CVisibility [Name] [CConsDecl]
               | CTypeSyn QName CVisibility [Name] CTypeExpr
...
data CFuncDecl = CFunc QName Int CVisibility (Maybe CTypeExpr) CRules
...
--- </PRE>
data CRhs = CSimpleExpr CExpr | CGuardedExpr [(CExpr,CExpr)]
...
data CLocalDecl =
   ...
   | CLocalVars Name                                 -- local free variable 
                                                     -- declaration
