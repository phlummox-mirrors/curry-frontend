...
% Partitioned by Björn Peemöller, (bjp@informatik.uni-kiel.de)
%
\nwfilename{Base.lhs}
...
> module Base
>   ( -- * Converting from and to type expressions
>     module Base.Types
...
% 2011-02-04 (bjp): Moved to Base.Types
...
% 2011-02-04 (bjp): Moved to Base.Module
...
% 2011-02-04 (bjp): Moved to Base.Import
...
% 2011-02-04 (bjp): Moved to Base.OpPrec
initPEnv :: PEnv
initPEnv =
  predefTopEnv qConsId (PrecInfo qConsId (OpPrec CS.InfixR 5)) emptyTopEnv

% 2011-02-04 (bjp): Moved to Base.Type
initTCEnv :: TCEnv
...
% 2011-02-04 (bjp): Moved to Base.Value
initDCEnv :: ValueEnv
initDCEnv =
...
% 2011-02-03 (bjp): Moved to Base.Arity
initAEnv :: ArityEnv
initAEnv
   = foldr bindPredefArity emptyTopEnv (concatMap snd predefTypes)
 where
 bindPredefArity (Data ident _ ts)
    = bindArity preludeMIdent ident (length ts)

% 2011-02-03 (bjp): Moved to Base.Import
initIEnv :: ImportEnv
initIEnv = Map.empty

% 2011-02-03 (bjp): Copied to Types
...
% 2011-02-03 (bjp): See Curry.Base.Ident.identSupply

nameSupply :: [Ident]
nameSupply = map mkIdent [c : showNum i | i <- [0 ..] :: [Integer], c <- ['a'..'z']]
  where showNum 0 = ""
        showNum n = show n
